        ...
        <form action="dbadd.php" name="form" id="form" class="w-50 p-4 border border-2 rounded-2 shadow" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-9">
                    <select name="city" id="city" class="form-select w-75">
                        <option value="Choose.." <?php if ($city == 'Choose..') {
                                                        echo 'selected';
                                                    } ?>>Choose..</option>
                        ...
                        <option value="Goa" <?php if ($city == 'Goa') {
                                                echo 'selected';
                                            } ?>>Goa</option>
                    </select>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-9 gap-2 d-flex ">
                    <div class="form-check">
                        <input type="radio" name="gender" class="form-check-input" value="Male" <?php if ($gender == 'Male') {
                                                                                                    echo "checked";
                                                                                                } ?>>
                        <label for="Male" class="form-check-label">Male</label>
                    </div>
                    <div class="form-check">
                        <input type="radio" name="gender" class="form-check-input" value="Female" <?php if ($gender == 'Female') {
                                                                                                        echo "checked";
                                                                                                    } ?>>
            ...
            <div class="row mb-3">
                ...
                <div class="col-9 d-flex gap-2">
                    <div class="form-check">
                        <input type="checkbox" name="language[]" class="form-check-input" value="Hindi" <?php if (isset($language) && in_array("Hindi", explode(", ", $language))) {
                                                                                                            echo 'checked';
                                                                                                        } ?>>
                        <label for="Hindi" class="form-check-label">Hindi</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" name="language[]" class="form-check-input" value="English" <?php if (isset($language) && in_array("English", explode(", ", $language))) {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                        <label for="English" class="form-check-label">English</label>
                    </div>
                    <div class="form-check">
                        <input type="checkbox" name="language[]" class="form-check-input" value="Gujarati" <?php if (isset($language) && in_array("Gujarati", explode(", ", $language))) {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
